...
- Multi-child + MASTER_CHILD operating model is defined in `docs/MULTI_CHILD_OPERATING_MODEL.md`.
- Standalone Windows deployment/runbook is in `docs/STANDALONE_WINDOWS_RUNBOOK.md`.
